...
namespace UcenjeCS
{
    internal class E02VarijableTipoviPodatakaOperatori
    {
        ...
        public static void Izvedi()
        {
            ...
            Console.WriteLine(i/j); //djelenje - djelenje daje cijeli broj
            Console.WriteLine((float) i/j);//djelenje s decimalnim rezultatom
            ...
            //operator modulo
            //ostatak nakon cjelobrojnog djelenja
            int ostatak = 9 % 2;

            //za dvoznamekasti broj ispiši vrijednost jedinice
            ...
            //Prvo si postavi zadatak pa ga nakon 15 minuta riješiti
